...
export default Ember.Controller.extend({
  ...
  setLocationCoordinates: function(setCoordinates){
    ...
    this.get('ajax').ajaxRequest("https://maps.googleapis.com/maps/api/geocode/json?address=" + locationName +
        "&key=AIzaSyDOBtNUVb3u39Vnu2xcEhxlS8pyozc4Gvs", "GET", null, false).fail(function(data) {
          console.log(data);
    }).then(function(data) {
      console.log(data);
  ...
  whenIdRestaurantIsLoaded: function(){
    ...
    self.get('ajax').ajaxRequest("/api/v1/getAllCategories", "GET", null, false).fail(function(data) {
      console.log(data);
    }).then(function(data) {
      ...
      self.get('ajax').ajaxRequest("/api/v1/admin/getFilteredLocations", "POST",
        '{"itemsPerPage":1000, "pageNumber":1}', false).fail(function(data) {
        console.log(data);
      }).then(function(data) {
    ...
    if(this.get('model.idRestaurant') != null){
      //Set restaurant id
      self.get('ajax').ajaxRequest("/api/v1/getRestaurantDetails", "POST", '{"id":'+this.get('model.idRestaurant')+'}',
        ...
        self.get('ajax').ajaxRequest("/api/v1/admin/getRestaurantCategories", "POST",
          '{"id":'+self.get('model.idRestaurant')+'}', false).fail(function(data) {
            console.log(data);
        }).then(function(data) {
          //Set fetched items
  ...
  actions: {
    ...
    addItem: function(){
      ...
      if(!self.get('markerPositionError')){
        self.get('ajax').ajaxRequest("/api/v1/admin/addRestaurant", "POST", JSON.stringify(self.get('restaurant')),
          false).fail(function(data) {
            console.log(data);
        }).then(function(data) {
          //Display notification
    ...
    editItem: function(){
      ...
      if(!self.get('markerPositionError')){
        self.get('ajax').ajaxRequest("/api/v1/admin/editRestaurant", "POST", JSON.stringify(self.get('restaurant')),
          false).fail(function(data) {
            console.log(data);
        }).then(function(data) {
          //Display notification
