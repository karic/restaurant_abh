...
export default Ember.Route.extend({
  titleToken: 'Tables / Restaurants / Administration',
  ...
  getItems: function(){
    ...
    this.get('ajax').ajaxRequest("/api/v1/admin/getAllRestaurantTables", "POST", JSON.stringify(self.get('filter')),
  ...
  actions: {
    ...
    saveChanges: function(){
      ...
      this.get('ajax').ajaxRequest("/api/v1/admin/adminTableItems", "POST", data, false).fail(function(data) {
        console.log(data);
      }).then(function(data) {
        //Display notification
        self.set('notification.visible', true);
