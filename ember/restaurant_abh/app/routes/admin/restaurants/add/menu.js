...
export default Ember.Route.extend({
  ...
  getItems: function(){
    ...
    this.get('ajax').ajaxRequest("/api/v1/getRestaurantMenu", "POST", JSON.stringify(self.get('filter')),
  ...
  actions: {
    ...
    saveChanges: function(){
      ...
      this.get('ajax').ajaxRequest("/api/v1/admin/adminMenuItems", "POST", data, false).fail(function(data) {
        console.log(data);
      }).then(function(data) {
        //Display notification
        self.set('notification.visible', true);
