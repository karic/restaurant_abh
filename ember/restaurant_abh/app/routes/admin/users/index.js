...
export default Ember.Route.extend({
  titleToken: 'Users / Administration',
  ...
  getItems: function(){
    ...
    this.get('ajax').ajaxRequest("/api/v1/admin/getFilteredUsers", "POST", data, false).fail(function(data) {
      console.log(data);
    }).then(function(data) {
  ...
  actions: {
    ...
    deleteItem: function(id){
      ...
      this.get('ajax').ajaxRequest("/api/v1/admin/deleteUser", "POST", '{"id": '+id+'}', false).fail(function(data) {
        console.log(data);
      }).then(function(data) {
